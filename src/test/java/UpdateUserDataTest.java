...
public class UpdateUserDataTest {
    ...
    public static Object[][] getData() {
        ...
        return new Object[][]{
                {"iigorek@yandex.ru", faker.internet().emailAddress(), "142536", faker.internet().password(), "Igor", faker.name().firstName()},
                {"iigorek@yandex.ru", faker.internet().emailAddress(), "142536", "142536", "Igor", "Igor"},
                {"iigorek@yandex.ru", "iigorek@yandex.ru", "142536", faker.internet().password(), "Igor", "Igor"},
                {"iigorek@yandex.ru", "smirnova@yandex.ru", "142536", "142536", "Igor", faker.name().firstName()}
        };
    }
